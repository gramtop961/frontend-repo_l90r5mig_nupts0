    ...
    <section id="about" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight gradient-text">What we do</h2>
        ...
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f, i) => (
            <motion.div key={f.title} initial={{opacity:0,y:10}} whileInView={{opacity:1,y:0}} viewport={{ once: true }} transition={{delay: i*0.05}} className="rounded-2xl p-6 card-surface hover-raise hover-glow transition">
              <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-violet-500 to-cyan-400 text-white grid place-items-center soft-shadow">
                <f.icon size={20} />
              </div>
